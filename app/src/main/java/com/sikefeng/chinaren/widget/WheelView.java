...
import com.sikefeng.chinaren.utils.DensityUtil;

import java.util.ArrayList;

/**
 * 来源---http://blog.csdn.net/junzia/article/details/50979382
 */
//部分方法说明
...
public class WheelView extends View {
    ...
    private void measureData(){
        if(isStart){
            ...
            shader=new LinearGradient(0,0,0,height,new int[]{0xFFFFFFFF,0xAAFFFFFF,0x00FFFFFF,0x00FFFFFF,0xAAFFFFFF,0xFFFFFFFF
            },new float[]{
