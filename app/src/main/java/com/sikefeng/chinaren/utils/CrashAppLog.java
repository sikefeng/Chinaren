...
public abstract class CrashAppLog implements Thread.UncaughtExceptionHandler{
     ...
     * 允许最大日志文件的数量
     */
    private int limitLogCount = MAX_LIMIT;
     ...
     * 默认放在内存卡的root路径
     */
    private String cacheCrashLog = Environment.getExternalStorageDirectory().getAbsolutePath()+ File.separator;
    /**
     * 系统默认的异常类
     */
...
//                Thread.sleep(1000);
    ...
    private boolean hanlderException(Throwable throwable) {
        ...
        try {
            ...
            limitAppLogCount(limitLogCount);
    ...
    /**
     * 最大文件数量
     * @param limitLogCount int
     */
    private void limitAppLogCount(int limitLogCount) {

        try {

            File file = new File(cacheCrashLog);
    ...
    private void writerToFile(String s) {
        ...
        try {
             ...
             * 创建文件夹
             */
            File folder = new File(cacheCrashLog);
        ...
        try {
            ...
            if (packageManager != null) {
                ...
                if (packageInfo != null) {
                    ...
                    crashAppLog.put("崩溃时间", DateUtils.getCurrentDateTime2Str());
     ...
     * @param limitLogCount int
     */
    public void setLimitLogCount(int limitLogCount) {
        this.limitLogCount = limitLogCount;
    }
     ...
     * @return String
     */
    public String getCacheCrashLog() {
        return cacheCrashLog;
    }

    /**
     * setCAHCE_CRASH_LOG
     * @param cacheCrashLog String
     */
    public void setCacheCrashLog(String cacheCrashLog) {
        this.cacheCrashLog = cacheCrashLog;
    }
}
