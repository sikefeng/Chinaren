...
public final class SensorControler implements IActivityLifiCycle, SensorEventListener {
    ...
    private SensorControler() {
        mSensorManager = (SensorManager) XXApplication
                .getInstance().getSystemService(Activity.SENSOR_SERVICE);
